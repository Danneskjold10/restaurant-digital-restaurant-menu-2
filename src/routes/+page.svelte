<script lang="ts">
  ...
  const menuCategories = [
    {
      name: 'Tacos',
      image: '/images/tacos/tacos_2.jpg', // Correct image path
      items: [
        {
          name: 'Kebab',
          soloPrice: '$5.99',
    ...
    {
      name: 'Burgers',
      image: '/images/burgers/burger_1.jpg', // Correct image path
      items: [
        {
          name: 'Cheese Burger',
          soloPrice: '$8.99',
    ...
    {
      name: 'Sandwichs',
      image: '/images/sandwichs/sandwich_1.jpg', // Correct image path
      items: [
        {
          name: 'Maxi Kebab',
          soloPrice: '$7.99',
    ...
    {
      name: 'Nuggets',
      image: '/images/nuggets/nuggets_1.jpg', // Correct image path
      items: [
        {
    ...
    {
      name: 'Assiettes',
      image: '/images/assiettes/assiette_1.jpg', // Correct image path
      items: [
        {
          name: 'Assiette Kebab',
          soloPrice: '$6.99',
